...
An [Ansible playbook](https://github.com/dbrennand/home-ops/blob/devel/tailscale_playbook.yml) is used to install and configure Tailscale on all devices in my Homelab. The configuration for each device is managed via Ansible [group](https://github.com/dbrennand/home-ops/tree/devel/inventory/group_vars) and [host](https://github.com/dbrennand/home-ops/tree/devel/inventory/host_vars) vars.
